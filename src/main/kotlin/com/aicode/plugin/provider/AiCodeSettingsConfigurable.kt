...
class AiCodeSettingsConfigurable : Configurable {
    ...
    override fun getDisplayName(): String = "AiCode"
    ...
    private fun testSelected() {
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            ...
            ApplicationManager.getApplication().invokeLater {
                ...
                if (outcome.first) {
                    Messages.showMessageDialog(parent, outcome.second, "AiCode — Test Connection", Messages.getInformationIcon())
                } else {
                    Messages.showErrorDialog(parent, outcome.second, "AiCode — Test Connection Failed")
                }
            }
        }
    }
